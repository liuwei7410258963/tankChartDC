...
public class BzTraceRelOutGroup extends BaseEntity {
	...
	public Double getLeaveReduce() {
		return trace == null ? null : DoubleUtils.sub(trace.getEndLevel(), trace.getStartLevel(), 2);

	}

	public Double getVolumeReduce() {
		return trace == null ? null : DoubleUtils.sub(trace.getEndVolume(), trace.getStartVolume(), 2);
	}

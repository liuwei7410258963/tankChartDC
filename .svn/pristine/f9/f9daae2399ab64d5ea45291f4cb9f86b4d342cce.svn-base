...
public class BackToTank {
	...
	public boolean equals(Object o) {
		...
		BackToTank that = (BackToTank) o;
		return Double.compare(that.trueVolume, trueVolume) == 0 &&
				Objects.equals(tankNo, that.tankNo) &&
	...
	@Override
	public int hashCode() {
		return Objects.hash(tankNo, startTime, endTime, trueVolume);
	}
}

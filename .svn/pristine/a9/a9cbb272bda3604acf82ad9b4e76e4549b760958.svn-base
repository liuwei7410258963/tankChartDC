...
//	 * @return 导入模板文件内容
//	 */
//	public static void impTemplate(OutputStream outputStream,Class<?>... modelClasses) throws Exception{
//		// 导入模板实际就是导出若干个空对象
...
//			data.add(sheetData);
//		}
//		exp(outputStream,data, modelClasses);
//	}
//
//	/**
//	 * 将导入的Excel转换为模型对象
...
//	 * @return 导出的Excel文件内容
//	 */
//	public static void exp(OutputStream out,List<List<Object>> data, Class<?>... modelClasses) {
//		try {
//			if (data == null) {
...
//			if (row != null) {
//				Object productType = modelClass.newInstance();
//				boolean isAllNull = true;
//				for (int c = 0; c < columnInfos.size(); c++) {
//					Cell cell = row.getCell(c);
//					ExcelColumnInfo columnInfo = columnInfos.get(c);
//					if (readCellValueToModel(wb, cell, columnInfo, productType)) {
//						isAllNull = false;
//					}
//				}
//				if (!isAllNull) {
//					// 集成Validator校验
//					if (productType instanceof ExcelModelBase) {
//						ExcelModelBase modelBase = (ExcelModelBase) productType;
...
//
//	/** 读取单元格的值，返回是否读到非空值 */
//	private static boolean readCellValueToModel(Workbook wb, Cell cell, ExcelColumnInfo columnInfo, Object productType) {
//		Class<?> fieldType = columnInfo.field.getType();
//		ExcelModelBase modelBase = new ExcelModelBase();
//		if (productType instanceof ExcelModelBase) {
//			modelBase = (ExcelModelBase) productType;
//		}
...
//		if (value != null) {
//			try {
//				columnInfo.field.set(productType, value);
//			} catch (Exception e) {
//				throw new RuntimeException(e);
//			}
//		}
